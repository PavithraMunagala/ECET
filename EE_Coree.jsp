...
<%
   ...
   try {
       ...
       int i = stmt.executeUpdate("insert into EECore(SNO,Question,OptionA,OptionB,OptionC,OptionD,Answer) values('" +SNO+ "' , '" + Question + "' , '" + OptionA + "' , '" + OptionB + "' , '" + OptionC + "' , '" + OptionD + "' , '" + Answer + "')");
       if (i > 0) {
